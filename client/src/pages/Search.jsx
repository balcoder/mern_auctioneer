...
export default function Search() {
  ...
  useEffect(() => {
    ...
    // if we have any params change store in state
    if (
      searchTermFromUrl ||
      typeFromUrl ||
      parkingFromUrl ||
    ...
    // we have updated our state with url params so we can fetch
    // our data based on our search query
    ...
    // useEffect can't be async so we have to make fetchlisting async
    // and call it here
    fetchListings();
  }, [location.search]);
  ...
  const handleChange = (e) => {
    ...
    if (
      ...
      // check if e.target.checked is boolen of string as we get data from form and the url
      setSidebarData({
        ...sidebarData,
        [e.target.id]:
