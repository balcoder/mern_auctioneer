...
export default function CreateListing() {
  ...
  useEffect(() => {
    // can't add async to useEffect so call async fn inside to get paramid
    ...
    fetchListing();
    // useEffect triggered after every render, when you do a setX call returned
    // from useState in a useEffect, React will render that component again,
    //and useEffect will run again. This causes an infinite loop:
    // pass an empty array [] as the second argument to avoid an infinite loop
  }, []);
  ...
  const handleChange = (e) => {
    ...
    if (
      ...
      setFromData({
        ...formData,
        // use brackets to get bedrooms instead of "bedrooms" etc.
